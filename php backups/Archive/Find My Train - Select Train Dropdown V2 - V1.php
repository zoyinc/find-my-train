...
window.addEventListener('load', function () {	
	...
	//var trainSubmitButton = document.createElement("input");
	//trainSubmitButton.setAttribute("type", "submit");
	//trainSubmitButton.setAttribute("value", "CHanGE Me");
...
<?php 
	...
	foreach($query_results as $curr_result){
		...
		//echo "option.style.fontFamily = getComputedStyle(dummyButtonAnchor, null).getPropertyValue(\"font\") ; \n";
		//echo "testFont = getComputedStyle(dummyButtonAnchor, null).getPropertyValue(\"font\") ; \n";
		//echo "option.style.color = \"red\"; ";
		echo "trainSelect.appendChild(option); \n";
		
		
		//echo "<option value=\"" . $curr_result->train_number . "\"" . $selected_state . ">" . $curr_result->custom_name . "</option>";
	};
?>	
	// Append the various elements to the form
	dummyListDiv.replaceWith(trainSelect);
	//dummySubmitButton.replaceWith(trainSubmitButton);
	//trainSelectForm.append(trainSelect); 
	trainSelectForm.append(trainPostNoInput);
	//trainSelectForm.append(trainSubmitButton);
	//dummyListDiv.replaceWith(trainSelectForm);

	
	//dummyListDiv.append(trainSelectForm);
